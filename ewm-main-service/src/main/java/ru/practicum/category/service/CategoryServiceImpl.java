...
public class CategoryServiceImpl implements CategoryService {
    ...
    public CategoryOutputDto createCategory(CategoryInputDto categoryInputDto) {
        Category categoryCandidate = categoryMapper.toCategory(categoryInputDto);

        if (categoryRepository.findAll().contains(categoryCandidate)) {
        ...
        Category category = categoryRepository.save(categoryCandidate);
